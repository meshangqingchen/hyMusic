...
__DEFINE__(1683857630965, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1683857630966,"./event-store":1683857630967}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1683857630966, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1683857630967, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1683857630966,"./utils":1683857630968}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1683857630968, function(require, module, exports) {
...
return __REQUIRE__(1683857630965);
})()
